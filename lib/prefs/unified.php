...
// $Id: unified.php 66909 2018-07-07 14:48:30Z chibaguy $
...
function prefs_unified_list()
{
	return [
		'unified_engine' => [
			...
			'description' => tra('The search engine used to index the content of this Tiki site. Some engines are more suitable for larger sites, but require additional software on the server.'),
			'type' => 'list',
			'options' => [
		...
		'unified_lucene_terms_limit' => [
			...
			'description' => tra('Maximum number of terms to be generated. This value may need to be increased in the case of "Terms per query limit is reached" errors, especially with wildcard, range and fuzzy searches.'),
			'type' => 'text',
			'filter' => 'int',
			'units' => tra('terms'),
			'default' => 1024,
		...
		'unified_lucene_max_buffered_docs' => [
		...
		'unified_lucene_default_operator' => [
		...
		'unified_elastic_url' => [
			...
			'description' => tra('The The URL of any node in the cluster'),
			'type' => 'text',
			'filter' => 'url',
