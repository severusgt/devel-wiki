...
// $Id: wikiplugin.php 66927 2018-07-09 11:28:05Z chibaguy $
...
function prefs_wikiplugin_list($partial = false)
{
	...
	$prefs['wikiplugin_list_gui'] = [
		...
		'description' => tr('Experimental GUI for the List plugin, which is displayed in a popup form.') . (' ') . tr('(listgui)'),
		'tags' => ['experimental'],
		'default' => 'n',
