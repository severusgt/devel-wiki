 ...
 * $Id: pluginedit_list.js 65812 2018-03-28 09:27:37Z jonnybradley $
 *
...
$(document).ready(function () {
	...
	jqueryTiki.plugins.list = {
		...
		addPlugin: function (plugin, parentPath) {
			...
			var $paramsDivs = $("<div>").addClass("params clearfix"),
				value = "", otherParams = [];
		...
		fieldsSelector: function (value) {
			...
			if (this.objectType && this.fields.object_types.hasOwnProperty(this.objectType)) {
				...
				if (this.trackerId && this.trackers[this.trackerId]) {
					...
					for (var i in fields) {	// N.B. although fields.object_types are arrays here they appear as objects
