...
// $Id: wikiplugin_r.php 66915 2018-07-08 14:41:44Z chibaguy $
//
...
function wikiplugin_r_info()
{
	$info = [
		...
		'prefs' => [ 'wikiplugin_r' ],
		'description' => tra('Parse R syntax and show the output either from the code introduced between the plugin tags or from the file attached to a tracker item sent through PluginTracker. It can also be combined with Pretty Trackers to edit params from the script through web forms.'),
	];
