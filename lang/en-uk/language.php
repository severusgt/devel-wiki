...
"Enable icons to be defined for menu items" => "Allows to define icons for menu entries",
...
"Use this security service provided by Google instead of the default CAPTCHA" => "Use ReCAPTCHA, a specialised captcha service, instead of default CAPTCHA",
"Time zone" => "Timezone",
