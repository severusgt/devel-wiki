...
"Specify if this Tiki site requires a proxy to access the internet. If enabled, the proxy Host name (either with or without the http:// prefix), Port settings, Username, and Password can be specified" => "Вживати проксі",
"users" => "користувачі",
"Private" => "особиста",
...
"My tasks" => "Мої задачі",
"My items" => "Мої пункти",
"Maximum size of each attachment" => "Максимальний розмір поштового долучення",
"Complete" => "Повністю",
