...
"Points" => "Pontok",
"Number per page" => "Alapértelmezett szám oldalanként",
"comments" => "komment",
"Display order" => "Alapértelmezett rendezés",
"pixels" => "pixel",
...
"Enable groups to each have their own visual theme." => "Minden csoportnak saját stílusa lehet",
"Subtitle" => "Alcím",
...
"The location of the row of Edit, Source, Rename, History, More buttons, etc." => "Oldal leírása, ikonok, backlinkek, ..",
"Top " => "Fent",
"Bottom" => "Lent",
"Neither" => "Egyik sem",
...
"Specify if this Tiki site requires a proxy to access the internet. If enabled, the proxy Host name (either with or without the http:// prefix), Port settings, Username, and Password can be specified" => "Proxy használata",
"Show the user's real name instead of username (log-in name), when possible." => "Felhasználó valódi nevének megjelenítése (ahol lehetséges)",
...
"Token" => "Token",
"Maximum size of each attachment" => "Csatolt állomány maximum mérete",
...
"Specify the location of the Save, Preview, and Cancel buttons on the wiki edit page" => "Gombok: Mentés, Előnézet, Visszavonás, ..",
...
"Minor edits don't flag new content for translation and don't cause watch notifications to be sent (unless \"Watch minor edits\" is enabled)." => "Kisebb szerkesztések nem számítanak lefordítandó új tartalomnak és értesítés sem kerül kiküldésre (kivéve ha az erre vonatkozó preferencia be van állítva)",
