...
"Specify if this Tiki site requires a proxy to access the internet. If enabled, the proxy Host name (either with or without the http:// prefix), Port settings, Username, and Password can be specified" => "Iusim proxy",
"users" => "olketa user",
"Private" => "Private",
...
"Maximum size of each attachment" => "Maximum size fo evriwan long olketa attachment",
"Complete" => "Finis",
