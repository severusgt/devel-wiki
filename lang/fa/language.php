...
"Specify if this Tiki site requires a proxy to access the internet. If enabled, the proxy Host name (either with or without the http:// prefix), Port settings, Username, and Password can be specified" => "از پروكسي(proxy) استفاده كن",
"users" => "كاربران",
"Public" => "عمومي؟",
"Private" => "شخصي",
...
"Maximum size of each attachment" => "بيشينه حجم هر ضميمه",
"Unlimited" => "نامحدود",
"Complete" => "كامل",
