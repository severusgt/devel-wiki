...
"Specify if this Tiki site requires a proxy to access the internet. If enabled, the proxy Host name (either with or without the http:// prefix), Port settings, Username, and Password can be specified" => "Käytä proxyä",
"users" => "käyttäjät",
"Public" => "Julkinen",
"Private" => "Yksityinen",
...
"Maximum size of each attachment" => "Jokaisen liitteen maksimi koko",
