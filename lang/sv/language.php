...
"Points" => "Poäng",
"Number per page" => "Förvalt antal per sida",
"comments" => "kommentarer",
"Display order" => "Förvald ordning",
"pixels" => "pixlar",
...
"Specify if this Tiki site requires a proxy to access the internet. If enabled, the proxy Host name (either with or without the http:// prefix), Port settings, Username, and Password can be specified" => "Använd proxy",
...
"My items" => "Mina saker",
"Maximum size of each attachment" => "Maximal storlek för varje bilaga",
